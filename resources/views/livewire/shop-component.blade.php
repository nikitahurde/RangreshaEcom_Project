                    ...
                    <div class="category-sidebar cat-side mb-30">
                        ...
                        <div class="category-item">
                            <ul>
                                ...
                                <li><a href="{{ route('user.category', ['category_slug' => $categorys->slug]) }}">{{$categorys->category_name}}</a></li>
                                @endforeach
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 cl-lg-3 col-md-6">
                                            <div class="product-03-wrapper grey-2-bg pos-rel text-center mb-30">
                                                ...
                                                <div class="product-text">
                                                    {{-- <h5>disable chair</h5> --}}
                                                    <h4><a href="{{ route('view-product', ['slug' => $item->slug]) }}">{{$item->name}}</a></h4>
                                        ...
                                        <div class="col-xl-4 col-lg-4">
                                            <div class="product mb-30">
                                                <div class="product-img">
                                                    <a href="{{ route('view-product', ['slug' => $item->slug]) }}"><img src="{{ asset('assets/images/product')}}/{{$item->image}}" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-8 col-lg-8">
                                            <div class="product-list-content mb-30">
                                                <div class="product-text">
                                                    ...
                                                    <h4><a href="{{ route('view-product', ['slug' => $item->slug]) }}l">{{$item->name}}</a></h4>
                                                    <span>{{$item->price}}</span>
                                                </div>
